...
public class techarea extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_techarea);
    ...
    private void configureToActionA(){
        ...
        action_a.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(techarea.this, stematel.class));
            }
        });
    }
    ...
    private void configureToActionB(){
        ...
        action_b.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(techarea.this, assignment.class));
            }
        });
    }
    private void configureToActionC(){
        ...
        action_c.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(techarea.this, students.class));
            }
        });
    }
    ...
    private void configureToActionD(){
        ...
        action_d.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(techarea.this, about.class));
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_techarea, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)){
                case 1:
                    rootView = inflater.inflate(R.layout.fragment_techarea1,container,false);
                    break;
                case 2:
                    rootView = inflater.inflate(R.layout.fragment_techarea2,container,false);
                    break;
                case 3:
                    rootView = inflater.inflate(R.layout.fragment_techarea3,container,false);
                    break;
                case 4:
                    rootView = inflater.inflate(R.layout.fragment_techarea4,container,false);
                    break;
                case 5:
                    rootView = inflater.inflate(R.layout.fragment_techarea5,container,false);
                    break;
            }
            return rootView;
        }
