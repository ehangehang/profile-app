...
public class students extends AppCompatActivity {
    ...
    private void configureToActionA(){
        ...
        action_a.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(students.this, stematel.class));
            }
        });
    }
    ...
    private void configureToActionB(){
        ...
        action_b.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(students.this, techarea.class));
            }
        });
    }
    private void configureToActionC(){
        ...
        action_c_.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(students.this, assignment.class));
            }
        });
    }
    ...
    private void configureToActionD(){
        ...
        action_d.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(students.this, about.class));
            }
        });
    }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)){
                case 1:
                    ...
                    break;
                case 2:
                    rootView = inflater.inflate(R.layout.fragment_students1, container, false);
                    break;
                case 3:
                    rootView = inflater.inflate(R.layout.fragment_students2,container, false);
                    break;
                case 4:
                    rootView = inflater.inflate(R.layout.fragment_students3,container,false);
                    break;
            }
            return rootView;
        }
